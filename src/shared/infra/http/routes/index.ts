...
import sessionsService from "@modules/sessions/infra/http/routes/sessions.routes";
...
routes.use("/sessions", sessionsService); // use to auto manage the route and find methods
